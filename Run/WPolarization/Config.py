...
process.WPolarization = cms.PSet(
    ...
    #HLTs=cms.vstring(),
    #HLTs=cms.vstring("HLTDiElectronMCTTBar2011", "HLTDiMuonMCTTBar2011" , "HLTMuElMCTTBar2011"),  #MC
    ...
    SelectorConfigs=cms.PSet(
        ...
        BTagScaleFactorSystematics = cms.int32(ApplyBTSFUnc), #0, 1 , -1
        NBJets = cms.int32(1),
        ...
        #TriggerNames=cms.vstring("HLTDiElectronMCTTBar2011", "HLTDiMuonMCTTBar2011" , "HLTMuElMCTTBar2011"), #MC
