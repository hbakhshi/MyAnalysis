...
process.ElectronCharge = cms.PSet(
    ...
    SelectorConfigs=cms.PSet(
        ElectronSelection=cms.PSet(
            ...
            CaloEnergy=cms.untracked.double(0) #10.0
        ),
        ...
        JetSelection=cms.PSet(
            ...
            PtCut=cms.double(15), #30
            Eta=cms.double(2.5),
            RejectCrack=cms.bool(False),
            DrElectron=cms.double(0.2), #0.4
            DrElectronMinPt=cms.double(20),
            RejectElectronsInGapAfterJetSelection=cms.bool(False),
            DrMuon=cms.double(0.2), #0.4
            DrMuonMinPt=cms.double(20)
        ),
        RejectInvMassLessThan12=cms.bool(False), #True
        RejectZRegion=cms.bool(False), #True #This rejects the event if after all cuts, the two leptons inv-mass lies between 76 and 106
        ...
        METCutOF=cms.double(0), #20
        METCutSF=cms.double(0), #30
        HTCut=cms.double(HTCutValue),
        NJets=cms.int32(0), #2
        HighLeptonPt=cms.double(10.0), #20.0
